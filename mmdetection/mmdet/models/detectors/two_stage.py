...
class TwoStageDetector(BaseDetector):
    ...
    def predict(self,
        ...
        # 加载你的图像文件，确保路径正确
        image_name = "001627.jpg"
        image_path = f'/root/model_saved/neuralnetwork_hw2/detectron2/datasets/VOC2007/JPEGImages/{image_name}'  # 修改为你的图像路径
        ...
        # 展示图像
        output_path = f'/root/model_saved/neuralnetwork_hw2/mmdetection/mmdetection/output_proposal_lzf/{image_name}'  # 设置输出文件的路径
